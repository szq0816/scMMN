...
def clustering(feature, true_labels, cluster_num):
    ...
    ari = metrics.adjusted_rand_score(true_labels, predict_labels.numpy())
    nmi = metrics.normalized_mutual_info_score(true_labels, predict_labels.numpy())
    f1 = metrics.cluster.fowlkes_mallows_score(true_labels, predict_labels.numpy())
